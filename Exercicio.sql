...
select departamento, count(*) from funcionarios GROUP by departamento order by 1; /*verificando quantos funcionarios de cada area tem.
...
SELECT sexo, COUNT(*) FROM funcionarios GROUP by sexo; /* quantidade de pessoas sexo masculino e feminino */ 
SELECT departamento, COUNT(*) FROM funcionarios GROUP by departamento; /* quantidade de pessoas em cada grupo de trabalho

/* verificando quantos trabalha em filmes e em lar*/ 

select sexo, departamento, count(*) from funcionarios where sexo = 'FEMININO' and (departamento = 'Filmes');
select sexo, departamento, count(*) from funcionarios where sexo = 'FEMININO' and departamento = 'lar' ;
